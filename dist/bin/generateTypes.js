...
function configToJsonSchema(config) {
    const fieldDefinitionsMap = new Map(); // mutable
    const entityDefinitions = [...config.globals, ...config.collections].reduce((acc, entity) => {
        acc[entity.slug] = (0, entityToJSONSchema_1.entityToJSONSchema)(config, entity, fieldDefinitionsMap);
        return acc;
    }, {});
    return {
        title: 'Config',
        ...
        properties: {
            collections: (0, entityToJSONSchema_1.generateEntitySchemas)(config.collections),
            globals: (0, entityToJSONSchema_1.generateEntitySchemas)(config.globals),
        },
